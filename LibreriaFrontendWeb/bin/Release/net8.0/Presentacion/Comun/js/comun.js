...
async function checkSession() {
    try {
        ...
        // Acá agregás esto para ver exactamente qué está devolviendo
        console.log("CheckSession response completa:", response);
        console.log("Tipo de response:", typeof response);
        console.log("Response === false:", response === false);
        console.log("Response == false:", response == false);

        if (!response.hasValidSession) {
            console.log("Entrando al bloque de sesión expirada");
            await Swal.fire({
                icon: 'warning',
